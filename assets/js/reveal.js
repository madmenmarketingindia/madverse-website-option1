...
(function () {
  ...
  var selectors = [
    ...
    ".profile-hero__index",
    ".profile-deck__head > *",
    ".profile-deck__viewer",
    ".insight-detail-hero__back",
    ".insight-detail-hero__content > *",
    ".insight-detail-hero__visual",
    ".insight-opening__aside",
    ".insight-opening__content > *",
    ".insight-chapters__head > *",
    ".insight-chapter",
    ".insight-principle",
    ".insight-framework__head > *",
    ".insight-framework__grid > li",
    ".insight-takeaways__head > *",
    ".insight-takeaways__list > li",
    ".insight-author__visual",
